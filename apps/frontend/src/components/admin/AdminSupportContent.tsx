  ...
  return (
    <div className="min-w-0 max-w-full space-y-6">
      <AdminPageHeader
        ...
        description="Atenda tickets do painel do cliente, responda dentro da plataforma e migre conversas para WhatsApp quando necessario."
        actions={
          <>
                  ...
                  >
                    <div className="flex flex-col gap-2">
                      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                        <p className="min-w-0 break-words text-sm font-semibold leading-snug text-slate-900 sm:text-base">
                          {ticket.subject}
                        </p>
                        <Badge className={`w-fit max-w-full shrink-0 ${statusBadgeClass[ticket.status] || "bg-slate-100 text-slate-800"}`}>
                      ...
                      <div className="grid grid-cols-1 gap-2 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-start">
                        <div className="min-w-0">
                          <p className="break-words text-sm font-medium text-slate-700">{ticket.customer?.name}</p>
                        ...
                        <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:justify-end">
                          ...
                          <Badge className={`justify-center sm:justify-start ${priorityBadgeClass[ticket.priority] || "bg-slate-100 text-slate-800"}`}>
