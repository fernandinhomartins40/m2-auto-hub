        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            {logo.url ? (
              ...
              <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-[1.35rem] bg-gradient-to-br from-primary to-primary-hover text-sm font-black tracking-[0.24em] text-white shadow-lg">
                M2
              </div>
            )}
