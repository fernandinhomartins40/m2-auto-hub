...
export const fallbackPublicSettings: PublicSettings = {
  ...
  pwaAdminName: "M2 Auto Painel",
  pwaAdminShortName: "M2 Painel",
  pwaAdminDescription: "Painel do lojista para vendas, operacao e gestao da loja.",
  ...
  pwaMechanicName: "M2 Auto Mecanico",
  pwaMechanicShortName: "M2 Oficina",
  pwaMechanicDescription: "App da oficina para mecanicos acompanharem revisoes e checklist.",
